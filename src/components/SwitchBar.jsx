  ...
  return (
    <StyledWrapper>
      <label id="theme-toggle-button">
        ...
        <svg viewBox="0 0 69.667 44" xmlnsXlink="http://www.w3.org/1999/xlink" xmlns="http://www.w3.org/2000/svg" width="50" height="32"> {/* Adjusted width and height */}
          <g transform="translate(3.5 3.5)" data-name="Component 15 – 1" id="Component_15_1">
            <g filter="url(#container)" transform="matrix(1, 0, 0, 1, -3.5, -3.5)">
              <rect fill="#83cbd8" transform="translate(3.5 3.5)" rx="17.5" height={25} width="50.667" data-name="container" id="container" /> {/* Adjusted height and width */}
            </g>
            <g transform="translate(2.333 2.333)" id="button">
              <g data-name="sun" id="sun">
                <g filter="url(#sun-outer)" transform="matrix(1, 0, 0, 1, -5.83, -5.83)">
                  <circle fill="#f8e664" transform="translate(5.83 5.83)" r="10.167" cy="10.167" cx="10.167" data-name="sun-outer" id="sun-outer-2" /> {/* Adjusted radius */}
                </g>
                ...
                <circle fill="#fcf4b9" transform="translate(8.167 8.167)" r={5} cy={5} cx={5} id="sun-inner" /> {/* Adjusted radius */}
              </g>
              <g data-name="moon" id="moon">
                <g filter="url(#moon)" transform="matrix(1, 0, 0, 1, -31.5, -5.83)">
                  <circle fill="#cce6ee" transform="translate(31.5 5.83)" r="10.167" cy="10.167" cx="10.167" data-name="moon" id="moon-3" /> {/* Adjusted radius */}
                </g>
                <g fill="#a6cad0" transform="translate(-24.415 -1.009)" id="patches">
                  <circle transform="translate(43.009 4.496)" r={1.5} cy={1.5} cx={1.5} /> {/* Adjusted radius */}
                  <circle transform="translate(39.366 17.952)" r={1.5} cy={1.5} cx={1.5} data-name="patch" />
                  <circle transform="translate(33.016 8.044)" r={0.75} cy={0.75} cx={0.75} data-name="patch" />
                  <circle transform="translate(51.081 18.888)" r={0.75} cy={0.75} cx={0.75} data-name="patch" />
                  <circle transform="translate(33.016 22.503)" r={0.75} cy={0.75} cx={0.75} data-name="patch" />
                  <circle transform="translate(50.081 10.53)" r={1} cy={1} cx={1} data-name="patch" />
                </g>
              </g>
            </g>
...
const StyledWrapper = styled.div`
  ...
  #toggle:checked + svg #button {
    transform: translate(20px, 2.333px); /* Adjusted translation */
  }
